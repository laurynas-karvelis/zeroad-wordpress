...
<div class="wrap zeroad-admin">
    ...
    <div class="zeroad-layout">
        <div class="zeroad-main">
            <section class="zeroad-panel" aria-labelledby="zeroad-status-title">
                <h2 id="zeroad-status-title"><?php esc_html_e("Site status", "zero-ad-network"); ?></h2>
                <p><strong class="zeroad-status"><?php echo esc_html($enabled ? __("Enabled", "zero-ad-network") : ($hasPublisher ? __("Disabled", "zero-ad-network") : __("Setup needed", "zero-ad-network"))); ?></strong></p>
        ...
        <aside class="zeroad-sidebar" aria-label="<?php esc_attr_e("Setup help", "zero-ad-network"); ?>">
            <section class="zeroad-panel">
                <h2><?php esc_html_e("Finish your setup", "zero-ad-network"); ?></h2>
                <ol class="zeroad-steps">
            ...
            <section class="zeroad-panel">
                <h2><?php esc_html_e("Verification cache", "zero-ad-network"); ?></h2>
